  ...
  <body <?php body_class('payment-form-page'); ?>>
    ...
    <div class="payment-page">
      <main class="page">
        ...
        <button type="button" class="currency-chip" aria-label="Currency PHP">
        ...
        <form class="form" id="payment-form" action="#" method="post">
          ...
          <div class="field">
            ...
            >
              ...
              <svg id="eye-closed" viewBox="0 0 24 24" hidden>
